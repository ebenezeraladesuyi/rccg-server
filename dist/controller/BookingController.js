...
const createBooking = async (req, res) => {
    try {
        ...
        Promise.all([
            (0, emailService_2.sendBookingConfirmation)(newBooking),
            (0, emailService_2.sendAdminNotification)(newBooking)
        ]).catch(emailError => {
...
const updateBookingStatus = async (req, res) => {
    ...
    try {
        ...
        if (adminNotes) {
            const timestamp = new Date().toLocaleString();
            const adminName = ((_a = req.admin) === null || _a === void 0 ? void 0 : _a.email) || 'Admin';
        ...
        if (previousStatus !== status) {
            try {
                await (0, emailService_1.sendStatusUpdateEmail)(booking, status, adminNotes);
